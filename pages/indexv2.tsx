...
import { primaryPrompt, sentimentPrompt } from "../lib/prompts";
...
const Home: NextPage = () => {
  ...
  const generatePrompt = async (
    ...
    return primaryPrompt(handle, vibe, contact, userData);
  };

  const generateSentimentPrompt = async (
    handle: string,
    userData: string[]
  ) => {
    return sentimentPrompt(handle, userData);
  };
