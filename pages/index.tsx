...
const Home: NextPage = () => {
  ...
  const generatePrompt = async (handle: string, vibe: VibeType) => {
    ...
    const prompt = `Before reaching out to this person, take a look at their interests and recent activity on social media based on this data (${userData}) then 
    ...
    <div className="flex max-w-5xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-12 sm:mt-20">
        <a
          ...
          href="https://github.com/corradorossi/HallooGPT"
          target="_blank"
