...
const Home: NextPage = () => {
  ...
  const generatePrompt = async (
    ...
    const prompt = `I am going to show you all the recent tweets by ${handle}. Use the information and insight from the tweets to create a personalized and flattering greeting message. Make sure the message has a very ${vibe} vibe and ${vibe} tone. The message should be in the form of a ${contact}, and it should be roughly 240 characters long. The message should be friendly and endearing. Do NOT use hashtags in your writing. Here are the tweets I referenced earlier for you to use to personalize the message: ${userData}`;
    return prompt;
  };
    ...
    <div className="flex max-w-5xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-12 sm:mt-6">
        ...
        <h1 className="sm:text-4xl text-2xl max-w-[708px] font-bold text-slate-900">
          Make an impression! Input a Twitter handle & get a unique,
          tweet-worthy greeting powered by AI magic.✨
        </h1>
        <div className="max-w-xl w-full">
          ...
          <textarea
            ...
            placeholder={
              "Pick someone you'd like to connect with (e.g. @elonmusk)"
            }
          />
            ...
            <button
              ...
              onClick={async (e) => {
                generateDataUser(handle),
                  generateHalloo(
                    e,
                    await generatePrompt(handle, vibe, contact, userData)
                  );
              }}
            >
