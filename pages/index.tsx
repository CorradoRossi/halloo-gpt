...
const Home: NextPage = () => {
  ...
  const [tweetData, setTweetData] = useState<TweetData[]>(Data);
  ...
  const generateHalloo = async (
    ...
    console.log("Halloo result: ", result);
            ...
            <button
              ...
              onClick={async (e) => {
                generateDataUser(handle),
                  generateHalloo(
                    e,
                    //await generatePrompt(handle, vibe, userData)
                    await generateSentimentPrompt(handle, userData)
                  );
              }}
            >
